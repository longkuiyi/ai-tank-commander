...
export const BUFF_DURATION = 10000; // 10秒
export const AUTO_REGEN_INTERVAL = 3000; // 3秒回一次血
...
export const ITEM_BUFF_VALUES = {
  ...
  HEAL_REGEN_SEC: 3    // 医疗包额外提供的秒回
};

export const ITEM_COLORS = {
  [ItemType.SPEED]: '#fbbf24', // 橙黄色
  [ItemType.DEFENSE]: '#a855f7', // 紫色
  [ItemType.HEAL]: '#22c55e', // 绿色
  [ItemType.DAMAGE]: '#ef4444' // 红色
};

export const PLAYER_SPEED = 4;
export const AI_SPEED = 2.5;
...
export const HEALTH_PACK_HEAL = 20; // 立即恢复
export const HEALTH_PACK_REGEN_PER_SEC = 2; // 持续恢复
